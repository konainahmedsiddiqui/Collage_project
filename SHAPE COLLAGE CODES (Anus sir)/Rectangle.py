...
rectangle = cv2.rectangle(rectangle, (150, 150), (450, 450), (255, 255, 255), -1)
rectangle = cv2.rectangle(rectangle, (150, 150), (450, 450), (0, 0, 0), 50)

# Mask for rectangle shape
gray_rectangle = cv2.cvtColor(rectangle, cv2.COLOR_BGR2GRAY)
_, mask = cv2.threshold(gray_rectangle, 1, 255, cv2.THRESH_BINARY)

# Place images within rectangle shape
result = cv2.bitwise_and(rectangle, rectangle, mask=mask)
...
cv2.imwrite('rectangle_collage.jpg', result)
cv2.waitKey(0)
